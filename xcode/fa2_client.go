...
func NewXcodeFa2Client2(httpclient *http.Client, appleIdToken string, data *gsasrp.AnisseteData) *Fa2Client {
	client := &Fa2Client{httpClient: httpclient}
	client.serverURL = "https://gsa.apple.com/auth"
	client.headers = data.AddAnisseteHeaders(xcodeStep2Header())
...
//		return client
//	}
func (client *Fa2Client) SetAnisetteData(data *gsasrp.AnisseteData) {
	client.headers = data.AddAnisseteHeaders(xcodeStep2Header())
}
...
*/
func (client *Fa2Client) LoadTwoStepDevices() (*TwoStepDevicesResponse, *errorz.StatusError) {
...
校验短信或者电话验证码
*/
func (client *Fa2Client) verifySMSVoiceCode(phoneId string, code string, codeType string) (*httpz.HttpResponse, *errorz.StatusError) {
	...
	_, result := ParseItcAuthResponseAs[map[string]any](response, http.StatusOK, http.StatusNoContent, http.StatusAccepted)
	//if result == nil {
	//	client.TrustDevice()
	//}
...
*/
func (client *Fa2Client) verifyDeviceCode(code string) (*httpz.HttpResponse, *errorz.StatusError) {
...
func (client *Fa2Client) RequestVerifyCode(codeType string, phoneId string) (*TwoStepDevicesResponse, *errorz.StatusError) {
	if codeType == VerifyCodeMode_Device {
		s, re := client.requestDeviceCode()
		if s != nil {
...
func (client *Fa2Client) requestSMSVoiceCode(phoneId string, t string) (*TwoStepDevicesResponse, *errorz.StatusError) {
