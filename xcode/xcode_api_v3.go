...
//	func (that *XcodeApiV3) IsXCodeAPI() bool {
//		return strings.Index(that.ServiceURL, "developerservices2.apple.com") > 0
//	}
func (that *XcodeApiV3) BeforeReturnAction(response *http.Response) {
...
func (that *XcodeApiV3) ListDevices() *httpz.HttpResponse {
...
func (that *XcodeApiV3) AddDevicesValidate(udid string, deviceName string) *httpz.HttpResponse {
	urlStr := that.ServiceURL + "devices"
	return that.addAndValidateDevice(udid, deviceName, urlStr)
}
func (that *XcodeApiV3) AddDevices(udid string, deviceName string) *httpz.HttpResponse {
	urlStr := that.ServiceURL + "devices"
	return that.addAndValidateDevice(udid, deviceName, urlStr)
}
func (that *XcodeApiV3) addAndValidateDevice(udid string, deviceName string, urlStr string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) UpdateDeviceName(deviceIdID string, deviceName string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) UpdateDeviceStatus(deviceIdID string, enable bool) *httpz.HttpResponse {
	urlStr := that.ServiceURL + "devices/" + deviceIdID
	status := "DISABLED"
	if enable {
		status = "ENABLED"
...
// -------------------------------------------------------------------------------------------------------------------------------------------------------
func (that *XcodeApiV3) ListBundleID() *httpz.HttpResponse {
...
func (that *XcodeApiV3) GetBundleID(bundleIDId string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) AddBundleID(bundleId string, name string, enablepush bool) *httpz.HttpResponse {
	urlStr := that.ServiceURL + "bundleIds"
...
func (that *XcodeApiV3) RemoveBundleID(bundleIDId string) *httpz.HttpResponse {
	urlStr := that.ServiceURL + "bundleIds/" + bundleIDId
	requestParams := `{"teamId":"%s"}`
	requestParams = fmt.Sprintf(requestParams, that.TeamId)
	request := httpz.Post(urlStr, that.JsonHttpHeaders).ContentType(httpz.ContentType_VND_JSON).
...
func (that *XcodeApiV3) UpdateBundleIDDes(bean *beans.BundleIDBean) *httpz.HttpResponse {
...
func (that *XcodeApiV3) GetBundleCapabilities(bundleIdID string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) UpdateBundleCapabilities(bean beans.BundleIDBean, capacityId string, enable bool) *httpz.HttpResponse {
	urlStr := that.ServiceURL + "bundleIds/" + bean.Id
...
func (that *XcodeApiV3) ListBundleIDByCertType(certTypeId string, platform string) *httpz.HttpResponse {
...
*/
func (that *XcodeApiV3) ListProfile(profileType string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) GetProfile(profileId string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) AddProfile(name string, profileType string, bundleIDid string, certIDs []string, deviceIDs []string) *httpz.HttpResponse {
	urlStr := that.ServiceURL + "profiles"
...
func (that *XcodeApiV3) RemoveProfile(profileId string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) ListCertifications(certificationType string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) GetCertification(certID string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) RemoveCertification(certId string) *httpz.HttpResponse {
	urlStr := that.ServiceURL + "certificates/" + certId
	requestParams := `{"teamId":"%s"}`
	requestParams = fmt.Sprintf(requestParams, that.TeamId)
	request := httpz.Post(urlStr, that.JsonHttpHeaders).ContentType(httpz.ContentType_VND_JSON).
...
*/
func (that *XcodeApiV3) AddCertification(csrContent, certTypeName string) *httpz.HttpResponse {
...
IOS_DEVELOPMENT IOS_DISTRIBUTION MAC_APP_DISTRIBUTION MAC_INSTALLER_DISTRIBUTION MAC_APP_DEVELOPMENT DEVELOPER_ID_KEXT DEVELOPER_ID_APPLICATION DEVELOPMENT DISTRIBUTION PASS_TYPE_ID PASS_TYPE_ID_WITH_NFC
*/
func (that *XcodeApiV3) AddCertificationWithAppId(csrContent, certTypeName string, appIdId string, displayName string) *httpz.HttpResponse {
...
func (that *XcodeApiV3) AddCertificationService(csrContent, appIdId, certTypeId string, certTypeIDFieldName string) *httpz.HttpResponse {
	//urlStr := "https://developer.apple.com/services-account/QH65B2/account/" + certTypePlatform + "/certificate/submitCertificateRequest.action"
...
/*
	func AddCertEasy(that *XcodeApiV3, certRoot string, email string, name string, password string, certTypeName string, saveAu bool, appidid string) (string, *errorz.StatusError) {
